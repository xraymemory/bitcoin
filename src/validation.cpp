...
#if defined(NDEBUG)
# error "manna cannot be compiled without assertions."
#endif
...
const std::string strMessageMagic = "manna Signed Message:\n";
                              ...
                              bool fOverrideMempoolLimit, const CAmount& nAbsurdFee, std::vector<COutPoint>& coins_to_uncache)
{
...

    {
        ...
        {
            LogPrint(BCLog::MEMPOOL, "replacing tx %s with %s for %s MNA additional fees, %d delta bytes\n",
