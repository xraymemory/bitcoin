...
/** manna unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class mannaUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit mannaUnits(QObject *parent);

    /** manna units.
      @note Source: https://en.manna.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        MNA,
...
typedef mannaUnits::Unit mannaUnit;
