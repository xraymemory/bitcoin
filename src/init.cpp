 ...
 * between mannad, and manna-qt and non-server tools.
*/
...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/manna/manna>";
    const std::string URL_WEBSITE = "<https://mannacore.org>";
...
/** Sanity checks
 *  Ensure that manna is running in a usable environment with all
...
static bool LockDataDirectory(bool probeOnly)
{
    ...
    // Make sure only a single manna process is using the data directory.
