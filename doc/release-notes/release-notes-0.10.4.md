manna Core version 0.10.4 is now available from:

  <https://manna.org/bin/manna-core-0.10.4/>
...
- #6953 `43c2789` Split manna-tx into its own package
- #6953 `dfe0d4d` Include manna-tx binary on Debian/Ubuntu
