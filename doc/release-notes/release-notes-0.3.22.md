Download URL: https://sourceforge.net/projects/manna/files/manna/manna-0.3.22/
...
Notable changes:
* Client will accept and relay TX's with 0.0005 MNA fee schedule (users still pay 0.01 MNA per kb, until next version)
...
* IRC is overflowing.  Client now bootstraps to channels #manna00 - #manna99
