manna Core version 0.13.2 is now available from:

  <https://manna.org/bin/manna-core-0.13.2/>
...
- #8908 `4a974b2` Update manna-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow manna-tx to create v2 transactions (btcdrak)
