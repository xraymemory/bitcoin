manna-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/manna/files/manna/manna-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the manna
...
New/changed settings (command-line or manna.conf file)
--------------------------------------------------------
