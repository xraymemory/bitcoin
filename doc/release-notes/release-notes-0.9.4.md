manna Core version 0.9.4 is now available from:

  https://manna.org/bin/0.9.4/
...
this update is incompatible with the manna system and could lead to consensus
forks.

manna Core released binaries from https://manna.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~manna/+archive/ubuntu/manna
- A third-party or self-compiled manna Core

upgrade to manna Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
