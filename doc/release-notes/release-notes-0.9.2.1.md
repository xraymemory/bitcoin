manna Core version 0.9.2.1 is now available from:

  https://manna.org/bin/0.9.2.1/
...
- Lower paytxfee warning threshold from 0.25 MNA to 0.01 MNA
...
- Fix "Start manna on system login"
