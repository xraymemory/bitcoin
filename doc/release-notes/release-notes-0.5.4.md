manna version 0.5.4 is now available for download at:
http://sourceforge.net/projects/manna/files/manna/manna-0.5.4/
...
http://gitorious.org/manna/mannad-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix manna-Qt notifications under Growl 1.3.
Increase required age of manna-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxmanna properly when installing manna-Qt over it. (Windows)
