...
This document provides guidelines for internationalization of the manna Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `manna_en.ts` remains unchanged.
