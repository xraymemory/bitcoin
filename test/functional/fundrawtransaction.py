...
class RawTransactionsTest(mannaTestFramework):
    ...
    def run_test(self):
        ...
        assert_raises_jsonrpc(-5, "changeAddress must be a valid manna address", self.nodes[2].fundrawtransaction, rawtx, {'changeAddress':'foobar'})
        ...
        mannad_processes[1].wait(timeout=BITCOIND_PROC_WAIT_TIMEOUT)
