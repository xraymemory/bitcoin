#!/usr/bin/env python3
# Copyright (c) 2014-2017 The manna Core developers
# Distributed under the MIT software license, see the accompanying
# file COPYING or http://www.opensource.org/licenses/mit-license.php.
"""Test mempool persistence.

By default, mannad will dump mempool on shutdown and
...
class MempoolPersistTest(mannaTestFramework):
    ...
    def run_test(self):
        ...
        # Give mannad a second to reload the mempool
        time.sleep(1)
